...
/**
 * SSO ko'prigi — MetricStay foydalanuvchisini avtomatik Mehmonxona-xizmati
...
/**
 * Mehmonxona-xizmati ADMIN paneli — MetricStay AppLayout ICHIDA sahifa sifatida.
...
export default function HotelServiceApp() {
  // MetricStay AppLayout aktiv mehmonxonani Outlet context orqali beradi.
