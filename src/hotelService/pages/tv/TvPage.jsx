    ...
    return (
      <TvShell primary={primary}>
        <div style={{ textAlign: "center" }}>
          ...
          <p style={{ marginTop: 40, fontSize: 15, opacity: 0.4 }}>MetricStay · Hotel TV</p>
        </div>
      </TvShell>
    );
  }
    ...
    return (
      <TvShell primary="#334155">
        <div style={{ textAlign: "center", maxWidth: 720 }}>
          ...
          <p style={{ marginTop: 40, fontSize: 15, opacity: 0.4 }}>MetricStay</p>
        </div>
      </TvShell>
    );
  }
  ...
  return (
    <TvShell primary={primary} align="stretch">
      ...
      <div style={{
        ...
        <span>◀ ▶ {ui.langHint} · Powered by MetricStay</span>
      </div>
    </TvShell>
  );
}
