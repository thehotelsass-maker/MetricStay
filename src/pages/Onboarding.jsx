      ...
      <div className="relative flex flex-col items-center justify-center p-6 sm:p-10">
        ...
        >
          ...
          <Link to="/" className="lg:hidden flex items-center justify-center gap-2.5 mb-8">
            <div className="w-9 h-9 rounded-xl bg-gradient-to-br from-primary to-[hsl(221_83%_42%)] grid place-items-center font-bold text-white shadow-lg">M</div>
            <span className="font-bold text-[15px]">MetricStay</span>
          </Link>
              ...
              return (
                <>
                  ...
                  <div className="text-center text-[11px] text-muted-foreground">
                    {t('supportPrompt')}{' '}
                    <a
                      href="https://t.me/metricstay_support"
                      target="_blank"
                      rel="noreferrer"
                    ...
                    {' · '}
                    <a href="mailto:info@metricstay.com" className="text-primary hover:underline font-medium">
                      Email
                    </a>
                  </div>
                </>
