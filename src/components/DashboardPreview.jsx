...
const TXT = {
  uz: {
    ...
    desc: "MetricStay - bu oddiy quruq raqamlar emas, o'ta chiroyli va qulay interfeysli tahlil tizimi. Har bir funksiya mehmonxona boshqaruvini zavqliroq qilish uchun dizayn qilingan.",
    tabPrices: 'Narxlar tahlili', tabReviews: 'Sharhlar', tabAi: 'AI maslahatlar',
    aiCard: 'AI Strategiyasi',
  },
  ru: {
    title: 'Как выглядит система?',
    desc: 'MetricStay — это не сухие цифры, а красивая и удобная аналитическая система. Каждая функция создана, чтобы управление отелем приносило удовольствие.',
    tabPrices: 'Анализ цен', tabReviews: 'Отзывы', tabAi: 'AI советы',
    aiCard: 'AI-стратегия',
  },
  en: {
    title: 'What does the system look like?',
    desc: 'MetricStay is not dry numbers — it is a beautiful, easy-to-use analytics system. Every feature is designed to make hotel management enjoyable.',
