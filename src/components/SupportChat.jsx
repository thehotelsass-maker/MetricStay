...
const WELCOME = {
  uz: 'Salom! Men MetricStay yordamchi assistentiman. Savollaringizga javob berishga tayyorman. Nima haqida ma\'lumot olmoqchisiz?',
  ru: 'Здравствуйте! Я помощник MetricStay. Готов ответить на ваши вопросы. О чём хотите узнать?',
  en: 'Hello! I\'m the MetricStay support assistant. I\'m ready to answer your questions. What would you like to know?',
};
...
const TITLE = {
  uz: 'MetricStay Yordam',
  ru: 'Помощь MetricStay',
  en: 'MetricStay Support',
};
