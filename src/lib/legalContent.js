...
export const CONTACT = {
  email: 'info@metricstay.com',
  telegram: '@metricstay_support',
  telegramUrl: 'https://t.me/metricstay_support',
  brand: 'MetricStay',
};
...
const uz = {
  about: {
    title: 'Biz haqimizda',
    intro:
      "MetricStay — mehmonxonalar uchun narx va reyting monitoringi platformasi. Biz O'zbekiston va mintaqadagi mehmonxonalarga raqobatchilar narxlarini kuzatish, OTA kanallaridagi ma'lumotlarni bir joyda ko'rish va sun'iy intellekt yordamida daromadni oshirishga yordam beramiz.",
    sections: [
      {
        h: 'Bizning vazifamiz',
  ...
  terms: {
    ...
    intro:
      "Ushbu shartlar MetricStay platformasidan foydalanishni tartibga soladi. Xizmatdan foydalanish orqali siz ushbu shartlarga rozilik bildirasiz.",
    sections: [
      {
        h: '1. Xizmat tavsifi',
        p: "MetricStay mehmonxonalar uchun narx monitoringi, reyting tahlili va daromad boshqaruvi vositalarini taqdim etadi. Biz uchinchi tomon platformalaridan (OTA) ochiq ma'lumotlarni yig'amiz va tahlil qilamiz.",
      },
      {
      ...
      },
      {
        ...
        p: "Obunani istalgan vaqtda bekor qilishingiz mumkin — bu joriy hisob-kitob davri oxirigacha amal qiladi. Qaytarish masalalari bo'yicha info@metricstay.com manziliga murojaat qiling.",
      },
      {
  ...
  privacy: {
    ...
    sections: [
      ...
      },
      {
        ...
        p: "Siz o'z ma'lumotlaringizga kirish, ularni tuzatish yoki o'chirishni so'rash huquqiga egasiz. Buning uchun info@metricstay.com manziliga murojaat qiling.",
      },
    ],
  },
  offer: {
...
const ru = {
  about: {
    title: 'О нас',
    intro:
      'MetricStay — платформа мониторинга цен и рейтингов для отелей. Мы помогаем отелям в Узбекистане и регионе отслеживать цены конкурентов, видеть данные OTA-каналов в одном месте и увеличивать доход с помощью искусственного интеллекта.',
    sections: [
      {
        h: 'Наша миссия',
  ...
  terms: {
    ...
    intro:
      'Настоящие условия регулируют использование платформы MetricStay. Используя сервис, вы соглашаетесь с этими условиями.',
    sections: [
      {
        h: '1. Описание сервиса',
        p: 'MetricStay предоставляет инструменты мониторинга цен, анализа рейтингов и управления доходом для отелей. Мы собираем и анализируем открытые данные со сторонних платформ (OTA).',
      },
      {
      ...
      },
      {
        ...
        p: 'Вы можете отменить подписку в любое время — она действует до конца текущего расчётного периода. По вопросам возврата обращайтесь на info@metricstay.com.',
      },
      {
  ...
  privacy: {
    ...
    sections: [
      ...
      {
        h: '6. Ваши права',
        p: 'Вы имеете право на доступ, исправление или удаление ваших данных. Для этого обращайтесь на info@metricstay.com.',
      },
    ],
  },
  offer: {
...
const en = {
  about: {
    title: 'About Us',
    intro:
      'MetricStay is a price and rating intelligence platform for hotels. We help hotels in Uzbekistan and the region track competitor prices, see OTA channel data in one place, and grow revenue with the help of artificial intelligence.',
    sections: [
      {
        h: 'Our mission',
  ...
  terms: {
    ...
    intro:
      'These terms govern your use of the MetricStay platform. By using the service you agree to these terms.',
    sections: [
      {
        h: '1. Service description',
        p: 'MetricStay provides price monitoring, rating analysis and revenue management tools for hotels. We collect and analyze publicly available data from third-party platforms (OTAs).',
      },
      {
        h: '2. Account and use',
      ...
      },
      {
        ...
        p: 'You can cancel your subscription at any time — it remains active until the end of the current billing period. For refund matters, contact info@metricstay.com.',
      },
      {
  ...
  privacy: {
    ...
    sections: [
      ...
      {
        h: '6. Your rights',
        p: 'You have the right to access, correct or request deletion of your data. To do so, contact info@metricstay.com.',
      },
    ],
  },
  offer: {
    ...
    intro:
      'This document is an official offer (Public Offer) by Lochin ekspres plyus MChJ (hereinafter — the "Licensor") to legal entities and sole proprietors (hereinafter — the "Licensee" or "User") to conclude an Agreement granting the right to use the SaaS platform metricstay.com under a simple (non-exclusive) license. Under Article 369 of the Civil Code of the Republic of Uzbekistan, full and unconditional acceptance of these offer terms is the User\'s registration in the System or payment for any Pricing plan.',
    sections: [
      {
        h: '1. Subject of the agreement',
        p: 'The Licensor grants the Licensee remote access, via the internet, to the metricstay.com software suite (including the AI price analysis module, review aggregator and QR-order system), and the Licensee undertakes to pay the subscription on time according to the Tariffs.',
      },
      {
